...
class Company final :
 ...
 public:
  ...
  bool has_multinational() const;
  private:
  bool _internal_has_multinational() const;
  public:
  void clear_multinational();
  bool multinational() const;
  void set_multinational(bool value);
  private:
  bool _internal_multinational() const;
  void _internal_set_multinational(bool value);
  public:
...
// optional bool multinational = 4;
inline bool Company::_internal_has_multinational() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Company::has_multinational() const {
  return _internal_has_multinational();
}
inline void Company::clear_multinational() {
  multinational_ = false;
  _has_bits_[0] &= ~0x00000008u;
}
inline bool Company::_internal_multinational() const {
  return multinational_;
}
inline bool Company::multinational() const {
  // @@protoc_insertion_point(field_get:Company.multinational)
  return _internal_multinational();
}
inline void Company::_internal_set_multinational(bool value) {
  _has_bits_[0] |= 0x00000008u;
  multinational_ = value;
}
inline void Company::set_multinational(bool value) {
  _internal_set_multinational(value);
  // @@protoc_insertion_point(field_set:Company.multinational)
}
