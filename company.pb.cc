...
const uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, foundation_year_),
  PROTOBUF_FIELD_OFFSET(::Company, multinational_),
  0,
  1,
  2,
  3,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rcompany.proto\"X\n\007Company\022\014\n\004name\030\001 \002(\t"
  "\022\017\n\007address\030\002 \002(\t\022\027\n\017Foundation_Year\030\003 \001"
  "(\005\022\025\n\rmultinational\030\004 \001(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_company_2eproto = {
  false, false, 105, descriptor_table_protodef_company_2eproto, "company.proto", 
...
class Company::_Internal {
 public:
  ...
  static void set_has_multinational(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
...
Company::Company(const Company& from)
  ...
  ::memcpy(&foundation_year_, &from.foundation_year_,
    static_cast<size_t>(reinterpret_cast<char*>(&multinational_) -
    reinterpret_cast<char*>(&foundation_year_)) + sizeof(multinational_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&foundation_year_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&multinational_) -
    reinterpret_cast<char*>(&foundation_year_)) + sizeof(multinational_));
}
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x0000000cu) {
    ::memset(&foundation_year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&multinational_) -
        reinterpret_cast<char*>(&foundation_year_)) + sizeof(multinational_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          goto handle_unusual;
        continue;
      // optional int32 Foundation_Year = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _Internal::set_has_foundation_year(&has_bits);
          foundation_year_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      // optional bool multinational = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _Internal::set_has_multinational(&has_bits);
          multinational_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_foundation_year(), target);
  }

  // optional bool multinational = 4;
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(4, this->_internal_multinational(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Company)
  ...
  if (cached_has_bits & 0x0000000cu) {
    // optional int32 Foundation_Year = 3;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_foundation_year());
    }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Company)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      foundation_year_ = from.foundation_year_;
    }
    if (cached_has_bits & 0x00000008u) {
      multinational_ = from.multinational_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, multinational_)
      + sizeof(Company::multinational_)
      - PROTOBUF_FIELD_OFFSET(Company, foundation_year_)>(
          reinterpret_cast<char*>(&foundation_year_),
          reinterpret_cast<char*>(&other->foundation_year_));
}
